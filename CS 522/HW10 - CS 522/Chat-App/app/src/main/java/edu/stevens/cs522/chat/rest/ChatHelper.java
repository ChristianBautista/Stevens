...
public class ChatHelper {
    ...
    public void postMessage(String chatRoom, String messageText, ResultReceiverWrapper receiver) {
        if (messageText != null && !messageText.isEmpty()) {
            ...
            Log.d("Sender ID",Long.toString(Settings.getSenderId(context)));
            // TODO: ID LINE
            ...
            /*
             * enqueue a request with workManager to post this message
            ...
            */
            workManager.enqueueUniqueWork(new OneTimeWorkRequest(PostMessageWorker.class,data));
        }
    }
    ...
    public void startMessageSync() {
        ...
        if (Settings.SYNC) {
            ...
            Bundle data = new Bundle();
            /*
            data.putInt("interval",SYNC_INTERVAL);
            syncRequest = new PeriodicWorkRequest(data.getParcelable("interval"));
    ...
    public void stopMessageSync() {
        ...
        if (Settings.SYNC) {
            ...
            //syncRequest.cancel(); has no effect. Must cancel whole sync on workManager
            //cancel on workManager
