...
public class ChatService extends Service implements IChatService {
    ...
    public void send(InetAddress destAddress, int destPort,
        ...
        data.putString(SendHandler.HDLR_DEST_ADDRESS, InetAddressConverter.addressToString(destAddress));
        ...
        // send message over background thread
    ...
    private final class SendHandler extends Handler {
        ...
        public void handleMessage(android.os.Message message) {
            ...
            try {
                ...
                destAddr = InetAddressConverter.fromAddress(data.getString(HDLR_DEST_ADDRESS));
                ...
                Log.d("Destination Port", Integer.toString(destPort));
                ...
                // Comment line below if not working
