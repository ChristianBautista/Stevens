...
(define (find-top-helper E V)
  (cond ((null? V) (tsort-error))
        ((eq? (indegree E (car V)) 0) (car V))
        (else (find-top-helper E (cdr V)))))
(define (find-top G)
  (if (null? G) (tsort-error) (find-top-helper (get-edges G) (get-vertices G))))
...
(define (pop-vertex G v)
  (if (null? G) '(()()) (list (popv-vertices (get-vertices G) v) (popv-edges (get-edges G) v))))
